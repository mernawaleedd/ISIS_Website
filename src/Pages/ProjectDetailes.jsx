    ...
    return (
        <>
            <div className="container py-16">
                ...
                <img src={ProjectDetailesBg} alt="Project Screen" className="m-auto w-[500px]" />
                <h3 className="p-2 mb-9 font-semibold text-3xl text-[#0E2F40]">Project Overview</h3>
                <p className="p-2 tracking-wide leading-relaxed text-xl text-[#5E5E5E] capitalize">
            ...
            <div className="bg-[#FBFBFB] py-32">
                <div className="max-w-4xl mx-auto text-[#5E5E5E]">
                    {/* Client */}
                    <div className="grid grid-cols-1 md:grid-cols-2 py-4 border-b ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 py-4 border-b ">
                        ...
                        <div className="flex flex-wrap gap-2 justify-end text-right">
                            {[
                                ...
                                <span key={index} className="bg-[#F6F6F6] text-sm px-5 py-3 rounded-full">
                                    {service}
                                </span>
                            ))}
                        </div>
            ...
            <div className="container py-16">
                <h3 className="p-2 mb-9 font-semibold text-3xl text-[#0E2F40]">The Client</h3>
                <p className="p-2 tracking-wide leading-relaxed text-xl text-[#5E5E5E] capitalize mb-16">
                ...
                <img src={ProjectDetailesImg} alt="Project Detailes Img" />
                <h3 className="p-2 mb-9 font-semibold text-3xl text-[#0E2F40] mt-16">The Result</h3>
                <p className="p-2 tracking-wide leading-relaxed text-xl text-[#5E5E5E] capitalize">
