    ...
    <div className="animate-on-scroll">
      ...
      <div className="bg-[#ffffff] animate-on-scroll">
        <div className="container py-16">
          ...
          <img src={NewsImg} alt="Event Image" className="w-96 m-auto animate-on-scroll" />

          <div className="w-96 mx-auto mt-4 text-left animate-on-scroll">
            <p className="mb-5 text-[#5E5E5E]">Mar 4, 2025</p>
            <img src={NewsLogos} alt="Logos" className="w-36 mt-2" />
          </div>
          <div className="animate-on-scroll p-12 font-medium text-lg text-[#0E2F40] tracking-widest leading-relaxed capitalize">
          ...
          <img src={NewsFS} alt="website screen" className="w-96 ml-auto m-12 animate-on-scroll" />
          <p className="animate-on-scroll p-12 font-medium text-lg text-[#0E2F40] tracking-widest leading-relaxed capitalize">The discussions also focused on future steps to ensure the sustainability and scalability of the system, reinforcing its alignment with Egypt’s environmental and infrastructure development goals.</p>
        </div>
      </div>
      <div className="bg-[#F6F6F6] animate-on-scroll">
        <div className="container py-16">
          ...
          <img src={image3} alt="Event Image" className="w-96 m-auto animate-on-scroll" />
          ...
          <p className="animate-on-scroll p-9 font-medium text-lg text-[#5E5E5E] tracking-widest leading-relaxed capitalize">As part of the follow-up on studies related to the JCAR project,
      ...
      <div className="bg-[#ffffff] animate-on-scroll">
        <div className="container py-16">
          ...
          <img src={Event3} alt="Event Image" className="w-96 m-auto animate-on-scroll" />
          ...
          <p className="animate-on-scroll p-9 font-medium text-lg text-[#5E5E5E] tracking-widest leading-relaxed capitalize">We had an engaging session at #CWW24 titled "How Asset Management Supports Decision-Making" as part of the PEPSI project. Moderated by Dr. Abdallah Hussein, the session brought together key experts, including Dr. Ayman Elsayed (Director of MED), Ms. Sonja Pans (Deltares), Dr. Moustafa Samir Moussa (Zewail City), Eng. Sayed Moustafa (Software team), and Dr. Samy Saad (HRI).
...
"
          ...
          />
           ...
           <p className="animate-on-scroll p-9 font-medium text-lg text-[#5E5E5E] tracking-widest leading-relaxed capitalize">Also, The interactive workshops had been held to train engineers on the use of asset management software. As a next step, an Asset Management Hackathon has been announced. The main goal of the Hackathon is for groups to present case studies showing how asset management can benefit any level of management, from the General Manager up to the Chairman. Also, it’ll explore ways to improve the system to make the organization run more efficiently.
          </p>
          <img src={Event5} alt="website screen" className="w-96 ml-auto m-12 animate-on-scroll " />
          <p className="animate-on-scroll p-9 font-medium text-lg text-[#5E5E5E] tracking-widest leading-relaxed capitalize">The session concluded with strong recommendations for expanding the asset management system, aligning with Egypt's Vision 2030 and supporting sustainable water infrastructure.
          </p>
        </div>
      </div>
      <div className="bg-[#F6F6F6] animate-on-scroll">
        <div className="container py-16">
          ...
          <img src={Event6} alt="Event Image" className="w-96 m-auto animate-on-scroll" />

          <div className="w-96 mx-auto mt-4 text-left animate-on-scroll">
            <p className="mb-5 text-[#5E5E5E]">July 2,2024</p>
              <img src={image4} alt="Logos" className="w-16 mt-2" />
          </div>
          <p className="animate-on-scroll p-9 font-medium text-lg text-[#5E5E5E] tracking-widest leading-relaxed capitalize">As part of the regular meetings for the Joint Cooperation for Applied Research project on water, funded by the Dutch side, one of the projects focuses on developing the water distribution system under the title: "Improvement of Water Distribution in Egypt through Enhanced Management of Water Quantities in Irrigation Channels."
          </p>
          <div className="animate-on-scroll">
          <AboutImageSection
